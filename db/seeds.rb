...
5.times do
game = Game.create(address: address[rand(1..5)], date: Date.new(2023, 5, 6), time: Time.new(2023, 5, 6, 12, 0, 0), user: User.find(rand(1..100)))
10.times do
  GameParticipant.create(game: game, user: User.find(rand(1..100)))
end
end
